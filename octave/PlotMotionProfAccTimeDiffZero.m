...
function [] = PlotMotionProfAccTimeDiffZero(dt_tilde, dx, 
                                            v_1, v_f, v_min, v_max)

    output = OctaveMotionProfAccTimeDiffZero(dt_tilde, dx, 
                                            v_1, v_f, v_min, v_max);
    ...
    figure_handle = figure(1, "name", "MotionProfAccTimeDiffZero");
